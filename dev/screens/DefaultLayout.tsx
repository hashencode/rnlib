...
import { Head, SIZE, useTheme } from '../../src';
...
export interface IDefaultLayoutProps {
    ...
    statusBarConfig?: SystemBarsProps; // 状态栏配置
...
export default function DefaultLayout(props: IDefaultLayoutProps) {
    ...
    return (
        <SafeAreaView {...safeAreaConfig} style={[styles.root, style?.root]}>
            ...
            <SystemBars hidden={theme.statusBar.hidden} {...statusBarConfig} />
            <View style={[styles.body, style?.body]}>
                ...
                {defaultScroll ? (
                    // 自带滑动区域
                    <ScrollView overScrollMode="never" bounces={false} {...scrollConfig}>
